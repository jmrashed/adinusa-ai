...
All notable changes to the Adinusa AI extension will be documented in this file.

## [0.4.0] - 2026-04-27

### Fixed
- Agent no longer executes `write_file` or `run_command` automatically — always requires user approval
- Fixed version numbers and missing metadata in package.json
...
- Build and package scripts for extension packaging
